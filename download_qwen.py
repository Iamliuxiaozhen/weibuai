...
def download_qwen_model():
    ...
    try:
        # Execute the snapshot download (Fixed: removed invalid argument)
        ...
        print("Suggestion: Please check your disk storage quota or network connection.", file=sys.stderr)
